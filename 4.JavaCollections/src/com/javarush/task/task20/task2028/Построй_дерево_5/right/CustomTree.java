package com.javarush.task.task20.task2028.Построй_дерево_5.right;
...
public class CustomTree extends AbstractList<String> implements Cloneable, Serializable {
     ...
     * Если после прохода по всей коллекции ни file1.txt элемент не способен иметь новые ветви, это означает, что все
